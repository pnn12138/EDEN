...
export const EDEN_LOCATIONS: Record<EdenLocationId, EdenLocation> = {
  ...
  naming_stone_bank: {
    ...
    name: "四河分流",
    shortDesc: "主河离开园子后分成多道水流，沿着不同方向流向远方。",
    description: "主河离开园子后分成多道水流，水声隆隆，沿着不同方向流向远方。",
    enterNarration:
      "你来到园子下方中央的河岸。主河离开园子后在这里分成多道水流，向四方流去。水声比上游更大，空气中弥漫着湿润的泥土气息。每一道水流都朝着不同的方向，奔向园外辽阔的远方。",
    enterNarrationNight:
      "夜晚的四河分流，水声在月光下显得更空旷。月色落在分流的河面上，影子被拉得很长。每一道水流都像是一个选择，一旦流出就不回头。",
    observeText:
      "河道在这里展开，水流分成数支，各自流向远方。水声隆隆，带着泥土和远方的气息。从分叉的水道望出去，能隐约感到园外世界的辽阔，但那是被守住的地方，不是蛇该去的方向。这里离园子中央已经有些距离，是园中较安静的一角。",
    observeTextNight:
      "月光落在分流的河面上，每道水流都闪着银光。夜风掠过水面，影子被拉得很长。这里的安静，像是在等待什么不可逆的选择。",
