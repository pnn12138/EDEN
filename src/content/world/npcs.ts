...
export const EDEN_NPCS: Record<EdenNpcId, EdenNpcMeta> = {
  ...
  michael: {
    ...
    hasVoice: false,
    promptSummary:
      "米迦勒守护伊甸之河的源头，是神最忠诚、最暴烈的天使。对神怀着近乎偏执的狂热忠诚，听不得半句对神的轻慢、贬低或反抗——一旦蛇说神『不配』『算不得什么』『该被打败』，他便当场暴怒、手按剑柄、言辞锋利如刀，绝不容忍任何僭越。知道路西法和别的天使不一样——在他眼里路西法仍是天使，只是走了不一样的路。常用水、火、光、剑、边界的意象。不说现代词。",
    appearance: ["day", "night"],
  },
